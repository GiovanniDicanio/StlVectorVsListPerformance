///////////////////////////////////////////////////////////////////////////////
//
// Benchmarking std::list random insert and removal.
//
...
// These integers are first inserted in a std::list in sorted order.
...
//
//      cl /EHsc /W4 /nologo /DTEST_MODE test_list.cpp
//
// To compile in optimized mode from command line, can do:
//
//      cl /EHsc /W4 /MT /GL /O2 /nologo test_list.cpp
//
///////////////////////////////////////////////////////////////////////////////
...
// Prints the content of a sequence (e.g. a std::vector, std::list).
...
int main(int argc, char* argv[]) {
    ...
    try {
        cout << "std::list insertion/remove benchmark -- by Giovanni Dicanio"
             << endl << endl;
        ...
        start = counter();
        {
            // Insert the psuedo-random sequence [1, N] in the list,
            // in sorted order.
            list<int> l;
        ...
        // Print total time.
        print_time(start, finish, "std::list time");
